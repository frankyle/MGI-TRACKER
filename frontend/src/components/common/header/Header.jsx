...
import { faChartLine } from '@fortawesome/free-solid-svg-icons';  // You can use a candle or chart icon
    ...
    <>
      <header>
        <div className='container flex'>
          <div className='logo'>
            {/* Candle Icon and MGI Candles Text */}
            <FontAwesomeIcon icon={faChartLine} className="candle-icon" />
            <span className="logo-text">MGI Candles</span>
          </div>
